...
ok so here we are saving a new dataframe however  ALL of the factor levels are saved into the new dataframe when there are only 2 countries within Oceania. Its not necessarily that its missing data from a column.  Why does table show all the factors for which there are no observations?
